...
CSV_PATH = "./data/rust-file-live-carmen-stats-node-counts-by-kind-55M-main.csv"
...
def load_node_counts(csv_path):
    ...
    if inner_counts[0] > 0:
        inner_counts[1] = inner_counts[1] + inner_counts[0]
        inner_counts[0] = 0
    if leaf_counts[0] > 0:
        leaf_counts[1] = leaf_counts[1] + leaf_counts[0]
        leaf_counts[0] = 0
