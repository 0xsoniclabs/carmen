...
def parse_performance_metrics(log_file_path):
    ...
    mgas_values = []
    rt_factors = []
    pattern = r'Processing block (\d+).*?, [\d.]+ txs/s, ([\d.]+) MGas/s, ([\d.]+)x realtime'
...
data = []
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/nightly_bench_9b783b82_5_go-file.log')), "go-file (S5)"))
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/nightly_bench_ac707b44_5_go-file-flat.log')), "go-file-flat (S5)"))
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/nightly_bench_50f881d9_6_rust-file.log')), "rust-file (S6)"))
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/nightly_bench_50f881d9_6_rust-file-flat.log')), "rust-file-flat (S6)"))
...
data = []
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/2025_12_17_S5_51M_blocks.log')), "go-file (S5)"))
data.append((itemgetter(0, 1)(parse_performance_metrics(
    './data/2026_01_23_S6_55M_blocks.log')), "rust-file (S6)"))
