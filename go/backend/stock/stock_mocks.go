...
// MockReadOnly is a mock of ReadOnly interface.
type MockReadOnly[I Index, V any] struct {
	ctrl     *gomock.Controller
	recorder *MockReadOnlyMockRecorder[I, V]
	isgomock struct{}
}

// MockReadOnlyMockRecorder is the mock recorder for MockReadOnly.
type MockReadOnlyMockRecorder[I Index, V any] struct {
	mock *MockReadOnly[I, V]
}

// NewMockReadOnly creates a new mock instance.
func NewMockReadOnly[I Index, V any](ctrl *gomock.Controller) *MockReadOnly[I, V] {
	mock := &MockReadOnly[I, V]{ctrl: ctrl}
	mock.recorder = &MockReadOnlyMockRecorder[I, V]{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockReadOnly[I, V]) EXPECT() *MockReadOnlyMockRecorder[I, V] {
	return m.recorder
}

// Close mocks base method.
func (m *MockReadOnly[I, V]) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockReadOnlyMockRecorder[I, V]) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockReadOnly[I, V])(nil).Close))
}

// Get mocks base method.
func (m *MockReadOnly[I, V]) Get(arg0 I) (V, error) {
	m.ctrl.T.Helper()
...
func (mr *MockReadOnlyMockRecorder[I, V]) Get(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockReadOnly[I, V])(nil).Get), arg0)
}
