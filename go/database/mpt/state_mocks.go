...
func (m *MockLiveState) Apply(block uint64, update *common.Update) ([]func() error, common.Releaser, error) {
	m.ctrl.T.Helper()
...
func (m *MockLiveState) RevertLastBlock(undo []func() error) error {
	m.ctrl.T.Helper()
