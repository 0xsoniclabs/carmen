...
// Source: verification_proof.go
//
// Generated by this command:
//
//	mockgen -source verification_proof.go -destination verification_proof_mocks.go -package io
//
...
func (m *MockverifiableArchiveTrie) GetBlockRoot(block uint64) (mpt.NodeId, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBlockRoot", block)
	ret0, _ := ret[0].(mpt.NodeId)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBlockRoot indicates an expected call of GetBlockRoot.
func (mr *MockverifiableArchiveTrieMockRecorder) GetBlockRoot(block any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBlockRoot", reflect.TypeOf((*MockverifiableArchiveTrie)(nil).GetBlockRoot), block)
}
