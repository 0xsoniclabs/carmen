...
func NewStateDBOpContext(t *testing.T, require *require.Assertions) *StateDBOpContext {
	...
	// Add some balance to avoid the account to be deleted at the end of the transaction
...
func makeSetStateFunc(ctx *StateDBOpContext) func() func() {
	return func() func() {
		...
		defer incValue(&ctx.value, 1) // Probably the defer is not needed
		return func() {
...
func makeSetNonceFunc(ctx *StateDBOpContext) func() func() {
	return func() func() {
		...
		defer func() { // Probably the defer is not needed
			ctx.nonce++
		}()
		return func() {
