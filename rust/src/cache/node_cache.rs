...
///
/// It stores a reference to an [`ErrorState`] to register any errors that occur during storage operations
/// as [`quick_cache::Lifecycle`] methods do not return.
...
impl<S: Storage> NodeCacheLifecycle<S> {
    /// Creates a new [`NodeCacheLifecycle`] with the given storage backend and error state reference.
