...
//                 fn get_root_id(&self, block_height: u64) -> BTResult<<Self as
// RootIdProvider>::Id, storage::Error>;

//                 fn set_root_id(&self, block_height: u64, root_id: <Self as RootIdProvider>::Id)
...
//                 fn add(&self, node: <Self as NodeManager>::Node) -> BTResult<<Self as
// NodeManager>::Id, Error>;
