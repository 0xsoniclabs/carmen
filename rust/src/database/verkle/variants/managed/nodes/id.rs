...
mod tests {
    ...
    fn from_idx_and_node_type_creates_id_from_lower_6_bytes_logic_or_node_type_prefix() {
        ...
        let cases = [
            ...
            (VerkleNodeKind::Inner3, 0x0000_1000_0000_0000),
            (VerkleNodeKind::Inner47, 0x0000_2000_0000_0000),
            (VerkleNodeKind::Inner256, 0x0000_3000_0000_0000),
            (VerkleNodeKind::Leaf1, 0x0000_4000_0000_0000),
            (VerkleNodeKind::Leaf2, 0x0000_5000_0000_0000),
            (VerkleNodeKind::Leaf21, 0x0000_6000_0000_0000),
            (VerkleNodeKind::Leaf64, 0x0000_7000_0000_0000),
            (VerkleNodeKind::Leaf141, 0x0000_8000_0000_0000),
            (VerkleNodeKind::Leaf256, 0x0000_9000_0000_0000),
        ];
    ...
    fn to_node_type_returns_node_type_for_valid_prefixes() {
        let cases = [
            ...
            (
                ...
                Some(VerkleNodeKind::Inner3),
            ),
            (
                VerkleNodeId([0x20, 0x00, 0x00, 0x00, 0x00, 0x2a]),
                Some(VerkleNodeKind::Inner47),
            ),
            (
    ...
    fn node_id_byte_size_returns_byte_size_of_encoded_node_type() {
        let cases = [
            ...
            (
                VerkleNodeId::from_idx_and_node_kind(0, VerkleNodeKind::Inner3),
                VerkleNodeKind::Inner3,
            ),
            (
                VerkleNodeId::from_idx_and_node_kind(0, VerkleNodeKind::Inner47),
            ...
            (
                VerkleNodeId::from_idx_and_node_kind(0, VerkleNodeKind::Leaf21),
                VerkleNodeKind::Leaf21,
            ),
            (
                VerkleNodeId::from_idx_and_node_kind(0, VerkleNodeKind::Leaf64),
                VerkleNodeKind::Leaf64,
            ),
            (
                VerkleNodeId::from_idx_and_node_kind(0, VerkleNodeKind::Leaf141),
