...
pub struct NodeCountVisitor {
    trie_count: NodeCountsByLevelAndKind,
}
...
mod tests {
    ...
    fn create_sample_trie_count() -> NodeCountsByLevelAndKind {
        let mut trie_count = NodeCountsByLevelAndKind::default();
